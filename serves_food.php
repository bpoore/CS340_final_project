    ...
    <div class="container">
      ...
      <h1>Taphouses Serving Food</h1>
        <table class="table table-striped">
          ...
          <tbody>
            <?php
              if(!($stmt = $mysqli->prepare("SELECT taphouse.name, taphouse.city, taphouse.state, food.food_type FROM taphouse INNER JOIN food ON taphouse.id=food.tap_id"))){
              ...
              if(!$stmt->bind_result($name, $city, $state, $food)){
